...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = mysqli_query($lien , "SELECT adresse_mail ,numéro_tel, nom_ville,code_postal FROM vendeur c INNER JOIN ville v ON c.id_ville = v.id_ville WHERE id_vendeur = $id_client");
