...
<template>
  <div id="app">
    <div v-if="!loggedIn">
      <h1 class="titre_connexion">Page Connexion Vendeur</h1>
      <form class="connexion_formulaire" @submit.prevent="login">
        ...
        <div class="menu_connexion">
          ...
          <router-link to="/connexion">Voir la page client</router-link>
    ...
    async login() {
      ...
      try {
        ...
        if (data.success) {
          ...
          localStorage.setItem('type_user', "vendeur"); 
          localStorage.setItem('vendeurId', data.userId); 
